...
class BaseCusDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        flown = np.load(flowpathn)

        occ = np.load(flowpath.replace('flo-', 'occ-'))
        occn = np.load(flowpathn.replace('flo-', 'occ-'))
